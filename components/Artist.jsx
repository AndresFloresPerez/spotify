...
import { ArtistSpotify, getRelatedArtists, getTopTracks } from '@/Services/SpotifyCore';
...
const Artist = ({ setView, globalArtistId, setGlobalArtistId, setGlobalCurrentSongId, setGlobalIsTrackPlaying }) => {
    ...
    async function getArtistData() {
        ...
        //     }
        // })
        const response = await ArtistSpotify(session.accessToken,globalArtistId)
    ...
    useEffect(() => {
        async function f() {
            if (session && session.accessToken) {
                ...
                setTopTracks(await getTopTracks(session.accessToken,globalArtistId))
                setRelatedArtists(await getRelatedArtists(session.accessToken,globalArtistId))
            }
        }
        f()
